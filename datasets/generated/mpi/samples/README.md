...
| `t2-2dsa-ms` | `variants/multispeed/t2-2dsa-ms_sample_synthetic.zip` | RA | Two speed steps, 40,000 then 50,000 rpm, one RA channel (T2-2DSA-MS, T2-GA-MS, T2-PCSA-MS) — 1A: RA; s ≈ 2.5 + 5.0 + 9.0 + 14.0 S |
